...
### Extra
Add https://github.com/safarlabs/sharp-layer as a Lambda Layer and apply it to the image-optimizer function. Doing it directly does not work using a ARM64 machine (M1/M2).
